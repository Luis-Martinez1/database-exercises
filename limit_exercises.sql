...
-- The number of employees returned is 362. The name of the oldest employee who was hired last is Khun Benini. The name of the youngest employee who was hired first is Douadi Pettis.
...
Order by hire_date
LIMIT 5;
-- Answer: the names of the 5 employees are Alselm Cappello, Utz Mandell, Bouchung Schreiter, Baocai Kushner, and Petter Stroustrup.
...
-- Answer: The relationship between offset, limit, and the page number is that the first 5 rows = the first page. 
